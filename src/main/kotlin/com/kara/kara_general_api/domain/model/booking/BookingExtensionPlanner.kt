...
object BookingExtensionPlanner {
    ...
    fun maxAdditionalMinutes(booking: Booking, nextBookingStart: Instant?, nextClosing: Instant?): Int {
    ...
    fun price(room: Room, booking: Booking, additionalMinutes: Int): BigDecimal {
    ...
    fun isValidDuration(additionalMinutes: Int, maxAdditionalMinutes: Int): Boolean =
