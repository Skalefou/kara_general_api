...
/** Conversation rattachée à une réservation, avec sa date de fermeture (fin + 24 h). */
data class BookingConversationResponse(
    ...
    val bookingId: UUID,
    @field:Schema(description = "Fermeture du chat (fin de la réservation + 24 h, ISO 8601, UTC)")
