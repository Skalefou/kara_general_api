...
data class RoomStockItemResponse(
    @field:Schema(description = "Identifiant du produit du catalogue générique")
    val productId: UUID,
    ...
    companion object {
        fun from(entry: RoomStockEntry): RoomStockItemResponse =
            RoomStockItemResponse(
